...
define( 'CPANEL_PASSWORD', 'cz*s6452u22&FaZ4');
/* Cpanel */
...
define( 'MHSECRETKEY', '!!##pushbutton##!!' );
define( 'ALLOWORIGIN', '' );
define( 'FROMMAIL', 'support@pushbutton-vip.com' );
define( 'FROMNAME', 'Push Buttons Team' );
...
define( 'MULTIPLE_STREAMS', 'multiple_streams' );
define( 'RECURRING_PASSIVE', 'recurring_passive' );
