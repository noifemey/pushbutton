...
<html lang="en">
<head>
    <title>Push Buttons - Login</title>
    <meta charset="utf-8">
    ...
    <div class="rcs_auth_wrapper">
        <div class="rcs_auth_inner">
            ...
            <div class="rcs_auth_form">
                ...
                <p>To keep connected with us please login with your personal information by email & password</p>
                <form>
                    <div class="rcs_auth_box">
                        <div class="rcs_auth_fields">
                            <label>Email Address</label>
                            <input type="text" data-req="1" data-msg="Email is required." name="email" class="rcs_input" value="<?php echo isset($email) ? $email : ''; ?>" placeholder="Enter your email here..."/>
                        ...
                        <div class="rcs_auth_fields">
                            ...
                            <input type="password" data-req="1" data-msg="Password is required." name="password" class="rcs_input" value="<?php echo isset($password) ? $password : ''; ?>" placeholder="**************"/>
                            <div class="rcs_auth_icon">
                    ...
                    <div class="rcs_auth_other">
                        <div class="rcs_auth_keep">
                            <label>
                                <input type="checkbox" name="remeber" class="rcs_checkbox" value="1">
                                <p>Remember Me</p>
                            </label> 
                        </div>
                        <div class="rcs_auth_forgot">
                            <a href="<?php echo base_url('forgot-password'); ?>" class="rcs_forgot_link">Forgot Password?</a>
                        </div>
                    </div>
                    <button type="submit" class="rcs_btn rcs_login_member">login</button>
                </form>
                <div class="rcs_regiester_link hide">
                    <p>Don’t have an account? <a href="<?php echo base_url('authentication/signup'); ?>">Create Account</a></p>
                </div>
            </div>
        </div>
    </div>
