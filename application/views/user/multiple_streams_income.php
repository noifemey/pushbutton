                ...
                <div class="rcs_table_head">
                    ...
                    <!-- <div class="rcs_table_head_right">
                        <div class="rcs_input_feild">
                            <form action="<?php //base_url('user/multipleStreamsIncome'); ?>" method="post"> 
                            ...
                            <ul>
                                ...
                                for($k=1;$k<=$tot;$k++){ 
                                    ...
                                    if($k == 1 || $k == $tot || $k == ($tot -1) || ($num == ($currentPage - PAGINATIONNUMBER)) || ($num == ($currentPage + PAGINATIONNUMBER)) || $num == $currentPage){
                                        echo '<li class="rcs_pagination_action ',($currentPage == $k) ? 'active' : '' ,'" ><a href="',base_url('user/multipleStreamsIncome/'.$k),'">',$k,'</a></li>';
                                    }else{
