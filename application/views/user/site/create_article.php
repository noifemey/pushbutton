                                                ...
                                                <div class="rcs_article_feild">
                                                    <div class="rcs_row">
														<div class="rcs_col">
															...
															<br/>
                                                            <input type="radio" id="noneVideo" name="video" value="noneVideo" checked>
                                                            <label for="noneVideo">None</label>
															...
															<div id="videoDiv">
                                                                ...
                                                                <input type="text" id="url_source" class="video-option rcs_custom_input input-hidden" placeholder="Enter URL Here"/>
                                                            </div>
														</div>
														<div id="divLocation" class="rcs_col hidden">
                                                            <div class="rcs_input_field">
                                                                <label for="videoLocation">Video Location:</label>
                                                                <select class="selectpicker rcs_input" name="videoLocation" id="videoLocation">
                                                                    <option value="top">Top(Below the Image)</option>
                                                                    <option value="bottom">Bottom(Before the Get Access Button)</option>
                                                                </select>
                                                            </div>
														</div>
													</div>
                                                ...
                                                <div class="rcs_row">
                                                    <div class="rcs_col rcs_full_col">
                                                        ...
                                                        <div class="rcs_article_content">
															<?php if(isset($products) && $products[0]['article_video'] != null){ ?>
																<div>
								...
								<div class="rcs_step_article_box">
									<div class="rcs_step_article_tabs">
										<ul>
                                            ...
                                            <li><a href="javascript:;" data-tag="rcs_new_article" class="">Article Crawler</a></li>
										</ul>
									</div>   
...
//                                                            $desc_data_dfy = array_reverse($data_dfy);
//                                                            foreach($desc_data_dfy as $item){
//                                                                echo "<option value='$item[id]'>$item[title]</option>";
//                                                            }
//                                                            ?>
                                                            <option value="1">Biz opp / MMO</option>
                                                            <option value="2">Heatlh and Fitness</option>
                                                            <option value="3">Personal Development</option>
                                                            <option value="4">Relationships and Dating</option>
                                                    ...
                                                    <div class="rcs_input_field">
                                                        ...
                                                        <select id="logicKeywords_id_new" name="logicKeywords_id_new" class="rcs_custom_input rcs_input" data-req="1" data-msg="Please select Category">
                                                            <option value="blank">Select Logic</option>
